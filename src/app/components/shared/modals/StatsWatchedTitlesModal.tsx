            ...
            <div className="flex gap-2">
              {TITLE_FILTER_OPTIONS.map(opt => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${filter === opt.value ? 'bg-[#dc2626] text-white' : 'bg-[#1c1c24] border border-[#27272a] text-gray-400 hover:text-white'
                    }`}
                >
                  {opt.label}
                </button>
