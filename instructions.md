...
10. **Vizuální ladění služeb** — Na základě zpětné vazby byly v katalogu vráceny textové štítky (badges) pro lepší čitelnost. V detailu filmu byla odstraněna loga z tlačítek přehrávání. Ve statistikách byla do legendy vrácena barva místo ikon. Barva Apple TV byla zesvětlena a v nastavení byly ikony služeb výrazně zvětšeny a přejmenovány pro maximální přehlednost.
